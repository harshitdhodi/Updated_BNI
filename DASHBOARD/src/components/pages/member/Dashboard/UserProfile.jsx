...
export default function UserProfile() {
  ...
  const [userData, setUserData] = useState({
    ...
    linkedin: "",
    twitter: "",
    password: "52104fd99a48327e7545f70e386556fa",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-2xl  shadow-lg overflow-hidden border border-gray-200">
          ...
          <div className="h-32 sm:h-40  relative">
            <div className="absolute inset-0 bg-red-300 bg-opacity-10"></div>
          </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-end  sm:justify-between">
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-end gap-4 -mt-16 sm:-mt-20">
                <div className="relative group">
                  <div className="w-32 h-32 rounded-2xl bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center text-white text-4xl font-bold border-4 border-white shadow-xl">
                    {userData.profileImg ? (
                      <img src={userData.profileImg} alt="Profile" className="w-full h-full rounded-2xl object-cover" />
                    ) : (
                      getInitials(userData.name)
                    )}
                  </div>
                  <button className="absolute bottom-2 right-2 bg-white rounded-full p-2 shadow-lg hover:bg-gray-50 transition-all">
                ...
                <div className="text-center sm:text-left relative -top-16 sm:mb-2">
                  <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">{userData.name}</h2>
              ...
              <div className="flex items-center gap-3 mt-4 sm:mt-0 justify-center sm:justify-end w-full sm:w-auto">
                {!isEditing ? (
                  ...
                  <>
                    ...
                    <button
                      onClick={() => setIsEditing(false)}
                      className="flex items-center gap-2 px-6 py-2.5 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors shadow-md hover:shadow-lg"
                    >
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex flex-wrap gap-3 mt-6">
              <div className={`px-4 py-2 rounded-full text-sm font-medium border ${getStatusBadge(userData.approvedByadmin)}`}>
                <span className="flex items-center gap-2">
                  ...
                  Admin: {userData.approvedByadmin}
                </span>
              </div>
              <div className={`px-4 py-2 rounded-full text-sm font-medium border ${getStatusBadge(userData.approvedBymember)}`}>
                <span className="flex items-center gap-2">
                  ...
                  Member: {userData.approvedBymember}
                </span>
              </div>
            ...
            {activeTab === "social" && (
              <div className="space-y-6">
                <div className="grid grid-cols-1 gap-6">
                  {[
                    { field: "facebook", label: "Facebook", icon: "📘", placeholder: "https://facebook.com/username", color: "blue" },
                    { field: "linkedin", label: "LinkedIn", icon: "💼", placeholder: "https://linkedin.com/in/username", color: "blue" },
                    { field: "twitter", label: "Twitter", icon: "🐦", placeholder: "https://twitter.com/username", color: "sky" }
                  ].map(social => (
        ...
        {/* Referral Code Card */}
        <div className="mt-6 bg-[#fff5f0] border border-red-500/40 rounded-2xl shadow-lg p-6 sm:p-8 text-white">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            <div className="text-center sm:text-left">
              ...
              <div className="inline-flex items-center gap-3 bg-white bg-opacity-20 backdrop-blur-sm rounded-lg px-6 py-3 border border-white border-opacity-30">
                <span className="text-3xl font-bold text-red-500 tracking-wider">{userData.refral_code}</span>
                <button className="p-2 bg-red-500 bg-opacity-70 rounded-lg hover:bg-opacity-30 transition-all">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
